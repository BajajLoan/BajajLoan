...
const PersonalLoanEMICalculator = () => {
  ...
  const [interestRate, setInterestRate] = useState(5); // Personal loan interest
  const [tenure, setTenure] = useState(24); // 2 years
  ...
  return (
    <div className="bg-white p-4 md:p-10 max-w-7xl">
      <h2 className="text-xl md:text-2xl font-bold mb-1 text-gray-800">
        Personal Loan EMI Calculator
      </h2>
      <p className="text-sm text-gray-500 mb-6">
        Estimate your monthly repayments for personal loans
      </p>
